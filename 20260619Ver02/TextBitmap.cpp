...
/**
 * This routine writes the values of the waveforms into a "bitmap" that can be processed in any way you like
 * For now, it just dumps it on the screen in a dumb terminal type situation
 */
